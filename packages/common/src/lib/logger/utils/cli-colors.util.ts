...
export const clc = {
  bold: colorIfAllowed((text: string) => `\x1B[1m${text}\x1B[39m`),
  ...
  darkGray: colorIfAllowed((text: string) => `\x1B[90m${text}\x1B[39m`),
}
export const yellow = colorIfAllowed((text: string) => `\x1B[38;5;3m${text}\x1B[39m`)
export const darkGray = colorIfAllowed((text: string) => `\x1B[38;5;0m${text}\x1B[39m`)
